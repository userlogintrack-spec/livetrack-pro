...
urlpatterns = [
    ...
    path('chats/<str:room_id>/auto-translate/', views.chat_toggle_auto_translate, name='chat_toggle_auto_translate'),
    path('email-mailboxes/', views.email_mailboxes_view, name='email_mailboxes'),
    path('most-clicked/', views.most_clicked_elements_view, name='most_clicked'),
    path('page-engagement/', views.page_engagement_view, name='page_engagement'),
    path('visitor-map/', views.visitor_map_view, name='visitor_map'),
    ...
    path('api/ai/kb-crawl/', views.ai_kb_crawl, name='ai_kb_crawl'),
